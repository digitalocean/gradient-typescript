...
export const tool: Tool = {
  name: 'retrieve_subject_schema_registry_databases_config',
  description:
  ...
  inputSchema: {
    ...
    required: ['database_cluster_uuid', 'subject_name'],
  },
  annotations: {
    readOnlyHint: true,
  },
...
export const handler = async (client: GradientAI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(args, await client.databases.schemaRegistry.config.retrieveSubject(subject_name, body)),
  );
};
