...
export const tool: Tool = {
  name: 'update_schema_registry_databases_config',
  description:
  ...
  inputSchema: {
    ...
    required: ['database_cluster_uuid', 'compatibility_level'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Gradient, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(args, await client.databases.schemaRegistry.config.update(database_cluster_uuid, body)),
  );
};
