...
export const metadata: Metadata = {
  ...
  operationId: 'get_openai_api_key',
};

export const tool: Tool = {
  name: 'retrieve_providers_models_openai',
  description:
...
export const handler = async (client: GradientAI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.models.providers.openai.retrieve(api_key_uuid));
};
