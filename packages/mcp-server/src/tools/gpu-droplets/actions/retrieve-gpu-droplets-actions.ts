...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v2/droplets/{droplet_id}/actions/{action_id}',
  operationId: 'dropletActions_get',
};

export const tool: Tool = {
  name: 'retrieve_gpu_droplets_actions',
  description:
...
export const handler = async (client: Gradient, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.gpuDroplets.actions.retrieve(action_id, body)),
  );
};
