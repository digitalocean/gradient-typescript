...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v2/droplets/backups/policies',
  operationId: 'droplets_list_backup_policies',
};

export const tool: Tool = {
  name: 'list_policies_gpu_droplets_backups',
  description:
...
export const handler = async (client: Gradient, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.gpuDroplets.backups.listPolicies(body)));
};
