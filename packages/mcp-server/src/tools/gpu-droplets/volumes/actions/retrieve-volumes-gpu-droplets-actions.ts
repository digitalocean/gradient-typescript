...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/v2/volumes/{volume_id}/actions/{action_id}',
  operationId: 'volumeActions_get',
};

export const tool: Tool = {
  name: 'retrieve_volumes_gpu_droplets_actions',
  description:
...
export const handler = async (client: Gradient, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.gpuDroplets.volumes.actions.retrieve(action_id, body)),
  );
};
