...
export const tool: Tool = {
  name: 'retrieve_openai_evaluation_metrics_agents_keys',
  description:
...
export const handler = async (client: Gradient, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.agents.evaluationMetrics.openai.keys.retrieve(api_key_uuid)),
  );
};
