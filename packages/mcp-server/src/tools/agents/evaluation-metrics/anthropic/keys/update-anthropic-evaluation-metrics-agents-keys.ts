...
export const tool: Tool = {
  name: 'update_anthropic_evaluation_metrics_agents_keys',
  description:
...
export const handler = async (client: GradientAI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(args, await client.agents.evaluationMetrics.anthropic.keys.update(api_key_uuid, body)),
  );
};
