...
export const tool: Tool = {
  name: 'list_agents_anthropic_evaluation_metrics_agents_keys',
  description:
...
export const handler = async (client: Gradient, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.agents.evaluationMetrics.anthropic.keys.listAgents(uuid, body));
};
