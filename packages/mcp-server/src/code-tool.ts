...
import Gradient, { ClientOptions } from '@digitalocean/gradient';
...
export function codeTool(): Endpoint {
  ...
  const handler = async (client: Gradient, args: unknown) => {
    ...
    try {
      const resp = await new Promise<Response>((resolve, reject) => {
        ...
        const opts: ClientOptions = {
          ...
          modelAccessKey: client.modelAccessKey,
          agentAccessKey: client.agentAccessKey,
          agentEndpoint: client.agentEndpoint,
