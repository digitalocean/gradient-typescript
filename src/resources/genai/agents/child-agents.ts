...
export class ChildAgents extends APIResource {
  ...
  update(
    ...
    return this._client.put(path`/v2/genai/agents/${path_parent_agent_uuid}/child_agents/${childAgentUuid}`, {
      body,
      ...options,
    });
  }
  ...
  delete(
    ...
    return this._client.delete(
      path`/v2/genai/agents/${parent_agent_uuid}/child_agents/${childAgentUuid}`,
      options,
    );
  }
  ...
  add(
    ...
    return this._client.post(
      path`/v2/genai/agents/${path_parent_agent_uuid}/child_agents/${childAgentUuid}`,
      { body, ...options },
    );
  }
  ...
  view(uuid: string, options?: RequestOptions): APIPromise<ChildAgentViewResponse> {
    return this._client.get(path`/v2/genai/agents/${uuid}/child_agents`, options);
  }
}
