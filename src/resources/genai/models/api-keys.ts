...
export class APIKeys extends APIResource {
  ...
  create(body: APIKeyCreateParams, options?: RequestOptions): APIPromise<APIKeyCreateResponse> {
    return this._client.post('/v2/genai/models/api_keys', { body, ...options });
  }
  ...
  update(
    ...
    return this._client.put(path`/v2/genai/models/api_keys/${apiKeyUuid}`, { body, ...options });
  }
  ...
  list(
    ...
    return this._client.get('/v2/genai/models/api_keys', { query, ...options });
  }
  ...
  delete(apiKeyUuid: string, options?: RequestOptions): APIPromise<APIKeyDeleteResponse> {
    return this._client.delete(path`/v2/genai/models/api_keys/${apiKeyUuid}`, options);
  }
  ...
  updateRegenerate(apiKeyUuid: string, options?: RequestOptions): APIPromise<APIKeyUpdateRegenerateResponse> {
    return this._client.put(path`/v2/genai/models/api_keys/${apiKeyUuid}/regenerate`, options);
  }
}
