...
export class Completions extends APIResource {
  ...
  create(
    ...
    options?: RequestOptions,
  ): APIPromise<Stream<AgentChatCompletionChunk>>;
  create(
    body: CompletionCreateParamsBase,
    options?: RequestOptions,
  ): APIPromise<Stream<AgentChatCompletionChunk> | CompletionCreateResponse>;
  create(
    body: CompletionCreateParams,
    options?: RequestOptions,
  ): APIPromise<CompletionCreateResponse> | APIPromise<Stream<AgentChatCompletionChunk>> {
    return this._client.post('/chat/completions', {
      body,
      defaultBaseURL: 'https://inference.do-ai.run/v1',
      ...options,
      stream: body.stream ?? false,
    }) as APIPromise<CompletionCreateResponse> | APIPromise<Stream<AgentChatCompletionChunk>>;
  }
}
...
export interface AgentChatCompletionChunk {
   ...
   */
  choices: Array<AgentChatCompletionChunk.Choice>;
   ...
   */
  usage?: AgentChatCompletionChunk.Usage | null;
}

export namespace AgentChatCompletionChunk {
