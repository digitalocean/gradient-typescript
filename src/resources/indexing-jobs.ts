...
export class IndexingJobs extends APIResource {
  ...
  create(body: IndexingJobCreateParams, options?: RequestOptions): APIPromise<IndexingJobCreateResponse> {
    return this._client.post('/v2/genai/indexing_jobs', { body, ...options });
  }
  ...
  retrieve(uuid: string, options?: RequestOptions): APIPromise<IndexingJobRetrieveResponse> {
    return this._client.get(path`/v2/genai/indexing_jobs/${uuid}`, options);
  }
  ...
  list(
    ...
    return this._client.get('/v2/genai/indexing_jobs', { query, ...options });
  }
  ...
  retrieveDataSources(
    ...
    return this._client.get(path`/v2/genai/indexing_jobs/${indexingJobUuid}/data_sources`, options);
  }
  ...
  updateCancel(
    ...
    return this._client.put(path`/v2/genai/indexing_jobs/${pathUuid}/cancel`, { body, ...options });
  }
}
