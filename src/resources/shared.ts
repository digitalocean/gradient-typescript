...
export interface CreateResponseResponse {
   ...
   */
  usage: CreateResponseResponse.Usage;
   ...
   */
  choices?: Array<CreateResponseResponse.Choice> | null;
   ...
   */
  tools?: Array<CreateResponseResponse.Tool> | null;
...
/**
 * Represents a streamed chunk of a text-to-text response returned by the model,
 * based on the provided input. VLLM models only.
 */
export interface CreateResponseStreamResponse {
  /**
  ...
  /**
   * A list of response choice chunks. Can contain more than one element if `n` is
   * greater than 1. Can also be empty for the last chunk if you set
   * `stream_options: {"include_usage": true}`.
   */
  choices: Array<CreateResponseStreamResponse.Choice>;

  /**
   * The Unix timestamp (in seconds) of when the response was created. Each chunk has
   * the same timestamp.
   */
  created: number;
...
export namespace CreateResponseStreamResponse {
  export interface Choice {
    /**
     ...
     * hit a natural stop point or a provided stop sequence, `length` if the maximum
     * number of tokens specified in the request was reached, or `tool_calls` if the
     * model called a tool. Only present in the final chunk.
     */
    finish_reason?: 'stop' | 'length' | 'tool_calls' | 'content_filter' | null;
  ...
  export namespace Choice {
    ...
    export interface Delta {
      /**
       * The contents of the chunk message. Can be null for chunks with tool calls or
       * other non-text content.
       */
      content?: string | null;

      /**
       * The reasoning content generated by the model. Only present when the model
      ...
      /**
       * The tool calls generated by the model, such as function calls. Only present when
