...
export class KnowledgeBases extends APIResource {
  ...
  create(body: KnowledgeBaseCreateParams, options?: RequestOptions): APIPromise<KnowledgeBaseCreateResponse> {
    return this._client.post('/v2/genai/knowledge_bases', { body, ...options });
  }
  ...
  retrieve(uuid: string, options?: RequestOptions): APIPromise<KnowledgeBaseRetrieveResponse> {
    return this._client.get(path`/v2/genai/knowledge_bases/${uuid}`, options);
  }
  ...
  update(
    ...
    return this._client.put(path`/v2/genai/knowledge_bases/${pathUuid}`, { body, ...options });
  }
  ...
  list(
    ...
    return this._client.get('/v2/genai/knowledge_bases', { query, ...options });
  }
  ...
  delete(uuid: string, options?: RequestOptions): APIPromise<KnowledgeBaseDeleteResponse> {
    return this._client.delete(path`/v2/genai/knowledge_bases/${uuid}`, options);
  }
}
