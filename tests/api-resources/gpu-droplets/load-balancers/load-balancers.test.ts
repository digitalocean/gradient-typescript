...
describe('resource loadBalancers', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.gpuDroplets.loadBalancers.create({ forwarding_rules: [{
    entry_port: 443,
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.gpuDroplets.loadBalancers.update('4de7ac8b-495b-4884-9a69-1050c6793cd6', { forwarding_rules: [{
    entry_port: 443,
    entry_protocol: 'https',
    target_port: 80,
    target_protocol: 'http',
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.gpuDroplets.loadBalancers.list({ page: 1, per_page: 1 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test.skip('deleteCache', async () => {
    const responsePromise = client.gpuDroplets.loadBalancers.deleteCache('4de7ac8b-495b-4884-9a69-1050c6793cd6');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
